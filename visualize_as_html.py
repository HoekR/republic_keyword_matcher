...
def test_HTML_representatie():
    # using html representatie
    ob = presentielijsten['year-1725-scan-255-odd-para-1']
    frob = ob.matched_text
    h = DisplayFragments(frob)
    HTML(h.get_schema())
    HTML(h.display_to_html())
