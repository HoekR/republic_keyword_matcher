...
from republic.republic_keyword_matcher.helpers.utils import *
...
def make_alternatives(searcher=None, term='', alternatives=[], matchlist={}):
    """
...
def match_previous(heer, res=pd.DataFrame):
    result = pd.DataFrame()
